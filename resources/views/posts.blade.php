...
@section('container')
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4 mb-3">
                <div class="card" >
                    <div class="position-absolute px-3 py-2" style="background-color: rgba(0, 0, 0, 0.4)"><a href="/posts?category={{ $post->category->slug }}" class="text-white text-decoration-none">{{ $post->category->name }}</a></div>
                    @if ($post->image)
    ...
    <article class="mb-4 border-bottom">
        ...
        <a href="/posts/{{ $post->slug }}" class="text-decoration-none d-block mt-3">Read more...</a>
    </article>
    @endforeach --}}
